...
<nav>
  <div class="mx-auto px-3 md:px-5 xl:px-20 justify-between items-center border-b-4 border-red-900 pb-4  pt-4 flex ">
    <img class=" w-10 md:w-16 hover:scale-110 transition delay-100 duration-200" src={logo} alt=" icon"/>
    <div class="">
      <!-- pulsanti -->
