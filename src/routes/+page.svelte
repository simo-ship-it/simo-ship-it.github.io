...
import sfondo from "../images/background.svg"
</script>
...
<div class="md:w-1/3 pt-0 mx-auto w-40 hidden md:block max-w-lg">
    <img src={io} alt="simone billeri" class= "drop-shadow-2xl "/>
</div>
</div>
